...
router.put('/:id', authController.protect, storyValidation.updateStory(), validate, storyController.updateStory);
router.delete('/:id', authController.protect, storyValidation.deleteStory(), validate, storyController.deleteStory);
